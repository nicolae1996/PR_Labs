...
namespace ProxyServer
{
    public class ProxyTestController
    {
        ...
        public ProxyTestController()
        {
            ...
            _proxyServer.TcpTimeWaitSeconds = 10;
            _proxyServer.ConnectionTimeOutSeconds = 15;
        ...
        public void StartProxy()
        {
            ...
            _explicitEndPoint = new ExplicitProxyEndPoint(IPAddress.Any, 8000);

            // Fired when a CONNECT request is received
            _explicitEndPoint.BeforeTunnelConnectRequest += OnBeforeTunnelConnectRequest;
            _explicitEndPoint.BeforeTunnelConnectResponse += OnBeforeTunnelConnectResponse;
        ...
        private async Task OnRequest(object sender, SessionEventArgs e)
        {
            ...
            await WriteToConsole("Active Client Connections:" + ((Titanium.Web.Proxy.ProxyServer)sender).ClientConnectionCount);
        ...
        private async Task OnResponse(object sender, SessionEventArgs e)
        {
            ...
            await WriteToConsole("Active Server Connections:" + ((Titanium.Web.Proxy.ProxyServer)sender).ServerConnectionCount);
